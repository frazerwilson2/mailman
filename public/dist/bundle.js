...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vueApp__ = __webpack_require__(1);
...
const funcs = {
  move: function (num){
    if(!num){num = 1}
    for (var i = 0; i < num; i++) {
      __WEBPACK_IMPORTED_MODULE_0__vueApp__["a" /* default */].PushCommand('app.move()');
    };
  },
  turn: function (cw){
    if(!cw){return;}
    var turn = cw === "R";
    __WEBPACK_IMPORTED_MODULE_0__vueApp__["a" /* default */].PushCommand('app.turn(' + turn +')');
  },
  deliverLetter: function (){
    __WEBPACK_IMPORTED_MODULE_0__vueApp__["a" /* default */].PushCommand('app.DeliverLetter()');
    // app.Knock();
  }
}
...
document.addEventListener("DOMContentLoaded", function(event) {
  document.querySelector('#runCode').addEventListener('click', function(){
	__WEBPACK_IMPORTED_MODULE_0__vueApp__["a" /* default */].ResetCommand();
	eval(editor.getValue());
	__WEBPACK_IMPORTED_MODULE_0__vueApp__["a" /* default */].InitCommands();
  });
});
